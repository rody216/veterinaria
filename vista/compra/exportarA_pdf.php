...
$datos = $impr->buscarAllBitacoraFechaA($desde,$hasta);
	...
	$content .= '
		<div class="row">
        	...
        	<div class="col-md-12">
				...
				<h1 style="text-align:center;">Reporte: Datos de la Compra</h1>
...
$pdf->output('../compra/reporte.pdf', 'F');
?>