 ...
 <!-- ELIMINAR -->
    <div class="modal fade" id="delete_<?php echo $datos[$x]['id_venta']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/>                
            ...
            <div class="modal-footer">
                ...
                <a href="../venta/anular?id=<?php echo $datos[$x]['id_venta']; ?>" class="btn btn-danger">Sí, anular</a>
            </div>
            ...
            <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="col-sm-8">
                     <label class="control-label">DNI del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="documentodni"  name="dni_due"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8" required class="form-control" placeholder="DNI del cliente..." />
                                        </div>
                                    </div>
                ...
                <div class="col-sm-8">
                    <label class="control-label">Nombre del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="nombres" name="nom_due" readonly required class="form-control" placeholder="Nombre del cliente..." />
                                        </div>
                                    </div>
                </div>
                 ...
                 <div class="col-sm-8">
                    <label class="control-label">Apellido del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="apellidoPaterno" name="ape_due" readonly required class="form-control" placeholder="Apellido del cliente..." />
                                        </div>
                                    </div>
                </div>
