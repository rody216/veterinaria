(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'es', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancelar', okText: 'OK', clearText: 'Limpiar', nowText: 'Now', switchOnClick: false};
